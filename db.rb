...
# Create method that creates a new table named authors
def create_table(table_name)
  connection.exec("CREATE TABLE #{table_name} (id SERIAL PRIMARY KEY, first_name VARCHAR(255), last_name VARCHAR(255) )")
